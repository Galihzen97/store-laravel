                ...
                <div class="form-group">
                  ...
                  >
                    <input
                      ...
                      :value="true"
                    />
                    <label for="storeOpenTrue" class="custom-control-label"
                      >Iya, Boleh</label
                    >
                  </div>
                  <div
                  ...
                  >
                    <input
                      ...
                      :value="false"
                    />
                    <label for="storeOpenFalse" class="custom-control-label"
                      >Gak, Makasih</label
                    >
                  </div>
                </div>
...
<script>
  ...
  var register = new Vue({
    ...
    data: {
      name: "Galih Zen Salim",
      email: "Galihwik@gmail.com",
      password: "",
      is_store_open: false,
      store_name: "",
    },
